...
Starting the engine without additional heaters is possible down to -30°C for petrol engines. Required is an engine oil with the correct viscosity, the correct fuel, performed services and a sufficiently charged conventional vehicle battery. It is necessary to do as follows:
